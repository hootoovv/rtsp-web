...
const workerBin = process.env.MEDIASOUP_WORKER_BIN
    ...
    : path.join(__dirname, '..', '..', 'worker', 'mediasoup-worker');
...
class Worker extends EnhancedEventEmitter_1.EnhancedEventEmitter {
     ...
     */
    constructor({ workerPath, logLevel, logTags, rtcMinPort, rtcMaxPort, dtlsCertificateFile, dtlsPrivateKeyFile, appData }) {
        super();
